...
7. Present the view URL with context:

   > "Your digest archive is live 📄 — [link]. Share this link with your regional leads, product partners, or anyone who wants to stay close to your market's user signals. Each week's digest gets added at the top automatically."
...
4. Present the same archive URL (link is unchanged):

   > "This week's digest has been added to your archive 📄 — [link]"
